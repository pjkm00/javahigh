...
//		System.out.println(persons.size());
		...
		persons.add(new Person("성춘향"));
		System.out.println(persons.size());
		//HashCode()를 equals메서드와 함께 재정의하지 않으면 코드가 예상과 다르게 작동하는 문제를 일으킨다. 
		//정확히 말하면 hash값을 사용하는 Collection(HashSet, HashMap, HashTable)에 문제가 생김
		//왜 그럴까? ==> hash값을 사용하는 Collection은 객체가 논리적으로 같은지 비교할 때 
		//우선적으로 hashCode() 리턴값을 확인하고 같으면 equals() 리턴값을 사용한다.
	}
