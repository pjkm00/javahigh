					...
					<form method="post" action="<%=request.getContextPath()%>/board/contentInsert.do">
						...
						<div class="card-body">
							<div class="form-group">
								...
								<input type="text" id="inputName" class="form-control" name="title" value="<%=boardVo != null ? boardVo.getBd_title() : ""%>" required>
							</div>
							<div class="form-group">
								<label for="inputDescription">내용</label>
								<textarea id="inputDescription" class="form-control" rows="20" name="content" ><%=boardVo != null ? boardVo.getBd_content() : ""%></textarea>
							</div>
							<div>
